...
def main(writing_time):
    ...
    county_po_url = 'https://entergy.utilisocial.io/datacapable/v1/map/events/EntergyMississippi/county?t={0}'.format(writing_time)
    scrape_helper.scrape_entergy(county_po_url, writing_time, entergymississippi_county_op_fp)

    zip_po_url = 'https://entergy.utilisocial.io/datacapable/v1/map/events/EntergyMississippi/zip?t={0}'.format(writing_time)
