...
def main(writing_time):
    ...
    county_po_url = 'https://entergy.utilisocial.io/datacapable/v1/map/events/EntergyTexas/county?t={0}'.format(writing_time)
    scrape_helper.scrape_entergy(county_po_url, writing_time, entergytexas_county_op_fp)

    zip_po_url = 'https://entergy.utilisocial.io/datacapable/v1/map/events/EntergyTexas/zip?t={0}'.format(writing_time)
